      ...
      {stats.map((stat) => {
        ...
        return (
          <button
            ...
            className="group relative flex flex-col p-7 md:p-10 bg-white border border-slate-100 rounded-modal md:rounded-modal hover:shadow-2xl hover:shadow-slate-200/60 hover:border-indigo-300 transition-all text-left overflow-hidden active:scale-[0.96]"
          >
