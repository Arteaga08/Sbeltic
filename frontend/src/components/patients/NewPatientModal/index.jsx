...
const NewPatientModal = ({ isOpen, onClose, onRefresh }) => {
    ...
    return (
      <div className="fixed inset-0 z-10000 flex items-center justify-center p-4">
        <div
          ...
          onClick={onClose}
        />
        <div className="relative w-full max-w-md bg-white rounded-modal shadow-2xl p-10 flex flex-col items-center text-center animate-in zoom-in-95 duration-500">
  ...
  return (
    <div className="fixed inset-0 z-10000 flex items-start justify-center p-4 pt-12 md:items-center md:pt-4">
      ...
      <div className="relative w-full max-w-2xl bg-white rounded-modal md:rounded-modal shadow-2xl overflow-hidden flex flex-col max-h-[85vh] md:max-h-[90vh] animate-in slide-in-from-top-4 duration-300">
