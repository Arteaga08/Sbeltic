    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="relative group">
        <textarea
          ...
          className="w-full p-8 bg-slate-50 border-2 border-transparent rounded-modal font-bold text-[11px] uppercase outline-none focus:bg-white focus:border-indigo-100 focus:ring-4 ring-indigo-50/50 transition-all min-h-62.5 resize-none leading-relaxed text-slate-700"
